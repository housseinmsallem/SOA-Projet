...
class AnalysisParameters(models.Model):
    ...
    min_value = models.DecimalField(
        db_column="MinValue", max_digits=10, decimal_places=2, null=True, blank=True
    )
    max_value = models.DecimalField(
        db_column="MaxValue", max_digits=10, decimal_places=2, null=True, blank=True
    )
...
class Barns(models.Model):
    ...
    location = models.CharField(
        db_column="Location", max_length=100, null=True, blank=True
    )
...
class Cows(models.Model):
    ...
    tag_number = models.CharField(db_column="TagNumber", max_length=50, unique=True)
    birth_date = models.DateField(db_column="BirthDate")

    class CurrentPhaseOptions(models.TextChoices):
        VEAU = "V", _("Veau")
        GENISSE = "GEN", _("Genisse")
        GESTATION = "GES", _("Gestation")
        LACTATION = "L", _("Lactation")
        TARIE = "T", _("Tarie")

    current_phase = models.CharField(
        db_column="CurrentPhase",
        max_length=3,
        choices=CurrentPhaseOptions.choices,
        default=CurrentPhaseOptions.VEAU,
    )
...
class CowBiologicalAnalysis(models.Model):
    ...
    parameter = models.ForeignKey(
        AnalysisParameters, models.DO_NOTHING, db_column="ParameterID"
    )
    date = models.DateField(db_column="Date")
    value = models.DecimalField(
        db_column="Value", max_digits=10, decimal_places=2, null=True, blank=True
    )
...
class Food(models.Model):
    ...
    category = models.CharField(
        db_column="Category", max_length=50, null=True, blank=True
    )
    quantity = models.DecimalField(
        db_column="Quantity", max_digits=10, decimal_places=2
    )
    unit = models.CharField(db_column="Unit", max_length=20, null=True, blank=True)
    reorder_level = models.DecimalField(
        db_column="ReorderLevel", max_digits=10, decimal_places=2, null=True, blank=True
    )
...
class CowHealth(models.Model):
    ...
    vet_name = models.CharField(
        db_column="VetName", max_length=100, null=True, blank=True
    )
    next_checkup_date = models.DateField(
        db_column="NextCheckupDate", null=True, blank=True
    )
...
class Employees(models.Model):
    ...
    base_salary = models.DecimalField(
        db_column="BaseSalary", max_digits=10, decimal_places=2
    )
    hourly_rate = models.DecimalField(
        db_column="HourlyRate", max_digits=10, decimal_places=2
    )
...
class EmployeeTasks(models.Model):
    ...
    task_description = models.CharField(
        db_column="TaskDescription", max_length=255, null=True, blank=True
    )
    hours_worked = models.DecimalField(
        db_column="HoursWorked", max_digits=5, decimal_places=2, null=True, blank=True
    )
...
class Suppliers(models.Model):
    ...
    contact_info = models.CharField(
        db_column="ContactInfo", max_length=255, null=True, blank=True
    )
...
class GoodsReceiptDetails(models.Model):
    ...
    received_quantity = models.DecimalField(
        db_column="ReceivedQuantity", max_digits=10, decimal_places=2
    )
...
class Machines(models.Model):
    ...
    last_maintenance = models.DateField(
        db_column="LastMaintenance", null=True, blank=True
    )
    next_maintenance = models.DateField(
        db_column="NextMaintenance", null=True, blank=True
    )
...
class MilkProduction(models.Model):
    ...
    quality = models.CharField(
        db_column="Quality", max_length=100, null=True, blank=True
    )
...
class MilkAnalysis(models.Model):
    ...
    milk_production = models.ForeignKey(
        MilkProduction, models.DO_NOTHING, db_column="MilkProductionID"
    )
    analysis_date = models.DateField(db_column="AnalysisDate")
    parameter = models.ForeignKey(
        AnalysisParameters, models.DO_NOTHING, db_column="ParameterID"
...
class PurchaseOrderItems(models.Model):
    ...
    ordered_quantity = models.DecimalField(
        db_column="OrderedQuantity", max_digits=10, decimal_places=2
    )
...
class UserAuth(AbstractUser):
    class Roles(models.TextChoices):
        ...
        VETERINARIAN = "VET", _("Vetrinairy")
        PRODUCTION_MANAGER = "PRD", _("Production_Manager")

    role = models.CharField(max_length=3, choices=Roles.choices, default=Roles.EMPLOYEE)
